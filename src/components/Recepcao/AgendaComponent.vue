    ...
    <div class="card p-3">
      <div class="card mb-3">
        ...
        <div class="button">
          ...
          <button type="submit" class="btn btn-outline-success" style="height: 40px; width: 270px; margin: 10px;">
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <div class="input-group mb-3">
                <input type="text" class="form-control" placeholder="Digite o nome do médico"
              ...
              <div class="time">
                <p class="subscribe">Das <input type="time"> as <input type="time"> <a href="#"><button class="btn btn-outline-success btn-sm" type="button" id="button-addon2"><i
