        ...
        <div class="col mt-1 mb-1">
          <div class="container-fluid mb-1">
            <button
              ...
              style="height: 70px; width: 140px; margin: 5px"
            >
              <i class="fa-solid fa-list-check"></i>> Indicadores
            </button>
            <button
              type="button"
              class="btn btn-outline-success border 1px solid botoes"
            ...
            <button
              ...
              data-bs-target="#formulario_buscar"
              role="button"
              area-expanded="false"
              aria-controls="collapseExample"
              style="height: 70px; width: 140px; margin: 5px"
            >
              <i class="fa-solid fa-hospital-user"></i> Convênio
            </button>
            <button
              type="button"
              class="btn btn-outline-success border 1px solid botoes"
              style="height: 70px; width: 140px; margin: 5px"
            >
              <i class="fa-solid fa-chart-pie"></i> Patrimônio
            </button>
            <button
              type="button"
              class="btn btn-outline-success border 1px solid botoes"
              style="height: 70px; width: 140px; margin: 5px"
            >
              <i class="fa-regular fa-file"></i> Notas
            </button>
            <button
              type="button"
              class="btn btn-outline-success border 1px solid botoes"
              style="height: 70px; width: 150px; margin: 5px"
            >
            ...
            <button
              ...
              class="btn btn-outline-success border 1px solid botoes"
              :class="{
                active: tabAtual == 'CadastrarEstabelecimentoComponent',
              }"
              @click="tabAtual = 'CadastrarEstabelecimentoComponent'"
              style="height: 70px; width: 150px; margin: 5px"
            >
...
import CadastrarEstabelecimentoComponent from "../components/Recepcao/CadastrarEstabelecimentoComponent.vue";
import CadastrarProfissionalComponent from "../components/Recepcao/CadastrarProfissionalComponent.vue";

const tabAtual = shallowRef("CadastrarConsultorioComponent");
