<template>
    <div>
        <div class="container" :class="{ 'sign-in-js': isRecuperar, 'sign-up-js': !isRecuperar }">
            <div class="content first-content">
                <div class="first-column">
                    <h2 class="title segundo-titulo">Recuperar</h2>
                    <p class="description description-primary"> Clique no botão abaixo, para recuperar sua senha!</p>
                    <button class="btn btn-primary" v-on:click="efeitoBtnRecuperar">Recuperar</button>
                </div>
            ...
            <div class="content second-content">
                <div class="first-column">
                    ...
                    <p class="description description-primary">Clique no botão abaixo para acessar o sistema!</p>
                    <button id="signup" class="btn btn-primary" v-on:click="efeitoBtnRecuperar">Acessar</button>
                </div>
                <div class="second-column">
